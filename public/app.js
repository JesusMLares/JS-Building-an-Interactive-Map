...
var polygon = L.polygon(latlings, {color: 'green'}).addTo(myMap);

map.fitBounds(polygon.getBounds())


// FIXME: Metro station markers:
...
// Zoom to the bounds of the layer group
myMap.fitBounds(stations.getBounds());
